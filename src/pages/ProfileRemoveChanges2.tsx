...
import styles from "./ProfileRemoveChanges2.module.css";

const ProfileRemoveChanges21: FunctionComponent = () => {
  const navigate = useNavigate();

  const onRectangle9Click = useCallback(() => {
    navigate("/profileremove-changes1");
  }, [navigate]);
...
export default ProfileRemoveChanges21;
